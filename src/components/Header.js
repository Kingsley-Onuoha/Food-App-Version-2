...
const Header = () => {
  ...
  return (
    <div className='h-18 sm:h-20 bg-white shadow-lg flex justify-between sm:px-10 sticky'>
        ...
        {user && <div className='flex justify-around items-center text-gray-600 font-bold sm:px-0 px-2'>
            <div className='flex items-center sm:mx-10 mx-2'>
                <img className='sm:w-12 w-7' src='https://t3.ftcdn.net/jpg/05/99/84/86/360_F_599848646_MdK7wVDJQZygObyKEahVkOuhh0IGdTt3.jpg' alt=''/>
            ...
            <div className='flex items-center sm:mx-10 mx-2' onClick={handleSignOut}>
                <img className='sm:w-6 w-3 sm:text-lg text-sm font-black' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6eM1sKCPuQI_UQ7XK7Mjzn1iRpSOVNSgcWox8DWe5GVHDvSxT9C3h2h8GlEyqPPMFwF0&usqp=CAU' alt=''/>
